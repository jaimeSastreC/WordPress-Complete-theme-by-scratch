...
<head>
    ...
    })(window,document,'script','dataLayer','GTM-WS7LDN3');</script>
    ...
    <div class="container">
        <header class="main-header">
            ...
            <div class="main-header__logo">
                <a href="<?php echo site_url(); ?>" class="logo-type"><?php bloginfo('name');?></a>
            </div>
            ...
            <nav class="main-header__nav">
                ...
                <?php 
                    if (has_nav_menu('top-menu-es')){
                        wp_nav_menu([
                            'theme_location' => 'top-menu-es',
                            'container' => false,
                        ]);
                    }
                ?>
